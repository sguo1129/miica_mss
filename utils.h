...
const float esun_mss_1[5] = {0.0, 1823.0, 1559.0, 1276.0, 880.1};
const float esun_mss_2[5] = {0.0, 1829.0, 1539.0, 1268.0, 886.6};
const float esun_mss_3[5] = {0.0, 1839.0, 1555.0, 1291.0, 887.9};
